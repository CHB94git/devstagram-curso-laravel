...
<body class="bg-gray-100">
        ...
        <div class="container mx-auto flex items-center justify-between">
            ...
            @auth
                <nav class="flex gap-3 items-center">
                    ...
                    <a class="font-bold text-gray-600 items-center"
                        href="{{ route('post.index', auth()->user()->username) }}">Hola:
            ...
            @guest
                <nav class="flex gap-3">
                    ...
                    <a class="font-bold uppercase text-gray-600" href="{{ route('register') }}">Create Account</a>
                </nav>
            @endguest
    ...
    <footer class="mt-10 text-center p-5 text-gray-500 font-bold uppercase">
        DevStagram &copy; - All rights reserved &trade; {{ now()->year }}
    </footer>
